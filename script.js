...
const characters = [
  ...
  },
  {
    ...
    tag: 'なっちゃんのパパ',
    color: '#6db8d4',
    desc: 'たのもしいパパ。お話の国のことを何でも知っているような気がするけど、じつはなっちゃんと一緒に探検しながら覚えていっている。'
  },
  {
    id: 'mama',
    name: 'ママ',
    ...
    tag: 'なっちゃんのママ',
    color: '#f5d76e',
    desc: 'やさしくてあたたかいママ。みんなのことを見守っていてくれる。おいしいごはんとおやつの魔法使い。'
  },
  {
    id: 'kota',
    name: '航太',
    ...
    tag: 'なかまのひとり',
    color: '#7bbf6a',
    desc: 'なっちゃんの大切なともだち。おっとりしているように見えて、じつはすごい知識を持っているひみつの天才。'
  },
  {
    id: 'nene',
    name: 'ねね',
